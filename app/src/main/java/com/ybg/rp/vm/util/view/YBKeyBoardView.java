 ...
 * @date 2016/6/24 0024
 */
public class YBKeyBoardView extends KeyboardView {
    ...
    public YBKeyBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public YBKeyBoardView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (Keyboard.Key key : keys) {
            ...
            } else if (mKeyBoard.equals(KeyboardUtil.abcNotKeyboard)) {
